...
<<<CODESQL
        ...
        INSERT INTO `spicials` (`id`, `name`, `description`, `way`, `favorite`, `photo`) 
        VALUES 
                                (NULL, :name, :description, :way, :favorite, :photo );
...
class Model
{
    ...
    static function envoyerRequeteSQL ($requetePrepareeSQL, $tabAssoColonneValeur)
    {
        ...
        $pdo = new PDO("mysql:host=localhost;dbname=spicial;charset=utf8", "root", "");
